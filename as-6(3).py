...
from demethods import euler_method_pro as eul, trapezoidal_method_pro as trapezoidal
...
def main():
    ...
    print(trapezoidal(dy_a, t0, y0, h, target, y_actual=y_a_actual, return_errors=True))
    ...
    print(trapezoidal(dy_b, t0, y0, h, target, y_actual=y_b_actual, return_errors=True))
    ...
    print(trapezoidal(dy_c, t0, y0, h, target, y_actual=y_c_actual, return_errors=True))
